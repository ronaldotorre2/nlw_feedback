        ...
        <>
            ...
            <form onSubmit={handleSubmitFeedback} className="my-4 w-full">
                <textarea 
                 ...
                 scrollbar scrollbar-thumb-zinc-700 scrollbar-trank-transparent scrollbar-thin" 
                ...
                <footer className="flex gap-2 mt-2">
                    ...
                    <button
                        type="submit"
                        className="p2 bg-brand-500 rounded-md border-transparent flex-1 flex justify-center
                        items-center text-sm hover:bg-brand-300 focus:outline-none focus:ring-2 focus:ring-offset-zinc-900
