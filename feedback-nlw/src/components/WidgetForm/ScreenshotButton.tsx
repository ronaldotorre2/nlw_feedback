...
interface SceenshotButtonProps {
    screenshot: string| null;
    onScreenshotTook: (screenshot: string | null) => void;
}

export function ScreenshotButton({ screenshot, onScreenshotTook }: SceenshotButtonProps) {
    ...
    return (
        <>
            <button
                ...
                transition-colors focus:outline-none focus:ring-2 focus:ring-offset-zinc-900
